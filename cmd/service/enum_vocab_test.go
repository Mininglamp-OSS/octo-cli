...
var requestSideVocabularies = []vocabulary{
	{op: "docs.create", in: "body", field: "templateId", want: []string{"blank", "signal", "terra", "orbital", "picnic"}, why: "Matches octo-docs-backend !146 at remote 711ad69be5c75a5820a6c4e8af23e71daf46f5b4 src/ppt/templates.ts. Old pitch/report/lesson IDs remain only in existing decks and matching committed receipt replays, not new creation. Product policy: octo-cli #174. A source ref is not deployment evidence; CHANGELOG records the rollout gate"},
