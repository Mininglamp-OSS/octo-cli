...
func TestOctoDocsSkillEmbedded(t *testing.T) {
	...
	for _, capability := range []string{"structural row/column edits", "find & replace", "freeze panes", "shared filters", "sorting", "data validation/dropdowns"} {
